...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(41)
    answer_from_my_code = factorial(41)
...
def run_test_count_cosines_from():
    ...
    # Test 5:
    expected = 2
    answer = count_cosines_from(5, 10, 0.29)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.336111  # This is APPROXIMATELY the correct answer.
