...
def draw_parallel_lines(n, point, length, window):
    ...
    finalPoint = rg.Point(point.x + length, point.y)
    line = rg.Line(point, finalPoint)
...
def draw_lines(n, point, window):
    ...
    ###########################################################################
    # -------------------------------------------------------------------------
    xCoordFinal = point.x + 100
    yCoordFinal = point.y + 100
    finalPoint = rg.Point(xCoordFinal, yCoordFinal)
    line = rg.Line(point, finalPoint)
    ...
    for _ in range(n):
        ...
        line.attach_to(window)
        window.render()
        finalPoint.y = finalPoint.y - (200/ (n - 1))
